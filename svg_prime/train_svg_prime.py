...
parser.add_argument('--M', type=float, default=1, help='scaling factor for LSTMs')
parser.add_argument('--K', type=float, default=1, help='scaling factor for encoder/decoder')
